...
export default function LibraryManagementSystem() {
  ...
  return (
    <div className="min-h-screen bg-rapunzel-bg font-rapunzel">
      {/* NAVBAR */}
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-3xl font-extrabold tracking-tight text-rapunzel-yellow">
            ...
            {[
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-6 py-4 font-medium rounded-t transition ${
                  activeTab === tab.id
                    ? "text-rapunzel-purple border-b-4 border-rapunzel-yellow bg-rapunzel-bg"
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 font-rapunzel">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-rapunzel-lavender rounded-xl shadow p-6 border-4 border-rapunzel-purple">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-rapunzel-card-yellow text-sm">Total Users</p>
                    <p className="text-3xl font-bold text-rapunzel-card-yellow">
                      {analytics.totalUsers || 0}
                    </p>
                  </div>
                  <Users className="w-12 h-12 text-rapunzel-card-yellow" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg shadow p-4 border-4 border-rapunzel-lavender">
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-rapunzel-bg">
                    <tr>
                  ...
                  <tbody className="divide-y divide-rapunzel-lavender">
                    {filteredBooks.map((book) => (
                      <tr key={book.id} className="hover:bg-rapunzel-bg">
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-rapunzel-green">
                    {filteredUsers.map((user) => (
                      <tr key={user.id} className="hover:bg-rapunzel-bg">
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-rapunzel-purple">
                    {transactions.map((transaction) => (
                      <tr key={transaction.id} className="hover:bg-rapunzel-bg">
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 font-rapunzel">
            <div className="bg-rapunzel-bg rounded-lg shadow-xl max-w-md w-full p-6 border-4 border-rapunzel-purple">
